                    ...
                    <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                        <div class="owl-carousel service-carousel position-relative">
                            <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                                <form action="LoginCheckerA" method="post">

                                    <marquee width="75%" direction="left" height="100px"><h3 align="center"> Accomodation user Login here</h3></marquee>
                                    <table border="2px" align="center" > 
                                        ...
                                        <tr>
                                            <td align="center"><button class="btn btn-lg btn-primary btn-block border-0" type="submit">Login</button></td>
                                                
                                            <td align="center"><button class="btn btn-lg btn-primary btn-block border-0" type="reset">Reset</button></td>
                                        </tr>
                                    </table>
                                </form><br/>
                                <p align="center"> Already registered? Click here to <a href=""><u> Login</u></p>
                            </div>
                        </div>
                    </div>
                </div>

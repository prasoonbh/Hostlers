            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-6 pr-lg-5">
                        <h6 class="text-primary font-weight-normal text-uppercase mb-3">Search your hostel </h6>
                        <h1 class="mb-4 section-title">You can search your hostel through pincode of our city</h1>
                        <p>Get a hostel according to your priority and requirements</p>
                    ...
                    <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                        <div class="owl-carousel service-carousel position-relative">
                            ...
                            <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                                <form action="SearchChecker" method="post" >
                                    <table align="center"border=10px >


                                        <tr>
                                            <td><strong>PINCODE</strong></td>
                                            <td><strong><input type="text" maxlength="6" id="pin" name="pincode" required="required" placeholder="Search the hostel with pincode.."></strong></td><br>
                                        </tr>

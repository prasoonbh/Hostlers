...
<html lang="en">
    ...
    <body>
        <%
          ...
          UserDTO user = udao.getUserData(name);
          }
        %>
        ...
        <table>
            <tr> 
                ...
                <td><strong> <%= user.getHostelname()%></strong></td>
                
            </tr>
            <tr> 
                <td><strong> Hosteladdress</strong></td>
                <td><strong><%=user.getHosteladdress()%></strong></td>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-7 m-0 my-lg-5 pt-5 pb-5 pb-lg-2 pl-lg-5">
                        ...
                        <h1 class="mb-4 section-title">Thank you for trusting us....</h1>
                        <p>We promise you to provide you a very robust service to get your customer....</p>
                        <div class="row py-2">
                            <div class="col-sm-6">
                    ...
                    <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                        <div class="owl-carousel service-carousel position-relative">
                            <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                                <h2> Hello , Thanks for trusting us...  </h2><br/>
                                <h4>This is the list of people who choose your hostel</h4>
                                <table border="2px"> 
                                    <tr>
                                        <td>Name</td>
                                        <td>Contact</td>

            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-6 pr-lg-5">
                        ...
                        <h1 class="mb-4 section-title">Awesome Interior Designing Services For Your Hostel</h1>
                    ...
                    <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                        <div class="owl-carousel service-carousel position-relative">
                            <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                                <form action="RegisterCheckerR" method="post" >
                                    <strong><marquee> Register Here </marquee></strong>
                                    <table align="center" border=2px>

                                        <tr>
                                            <td>NAME</td>
                                            <td><input type="text"  name="name" required="required" placeholder="Enter your name..."/>
                                        </tr>
                                        <tr>
                                            <td>CONTACT</td>
                                            <td> <input type="text" maxlength="10" name="contact" required="required" placeholder="Enter your contact"> </td>
                                        </tr>
                                        <tr>
                                            <td>EMAIL</td>
                                            <td> <input type="email" name="email" required="required" placeholder="Enter your email here..."> </td>
                                        </tr>
                                        <tr>
                                            <td>PASSWORD</td>
                                            <td><input type="password"required="required"name="password" placeholder="Enter your password.."/></td>
                                        </tr>
                                        <tr>
                                            <td><button class="btn btn-lg btn-primary btn-block border-0" type="submit">Submit Now</button></td><td><button class="btn btn-lg btn-primary btn-block border-0" type="reset">RESET</button></td>
                                        </tr>
                                    </table>
                                </form> <br/>
                                <strong> <p align="center"> Already Registered? Click here to  <a href="login.jsp"/>LogIn</p> </strong>              
                            </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-7 mt-5 py-5 pr-lg-5">
                        ...
                        <h1 class="mb-4 section-title">25+ Years Experience In providing the service of hostels</h1>
        ...
        <div class="container-fluid bg-dark text-white py-5 px-sm-3 px-md-5">
            ...
            <div class="container border-top border-secondary pt-5">
                <p class="m-0 text-center text-white">
                    ...
                    <a class="text-white font-weight-bold" href="https://htmlcodex.com">Prasoon Bhargava</a>
                </p>
            </div>
        </div>
        <!-- Footer End -->

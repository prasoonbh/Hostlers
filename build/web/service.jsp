                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="d-flex flex-column align-items-center justify-content-center bg-primary h-100 py-5 px-3">
                            ...
                            <h1 class="m-0">Years of services</h1>
                        </div>
                    </div>
            ...
            <div class="container py-5">
                <div class="row">
                    <div class="col-lg-6 pr-lg-5">
                        ...
                        <h1 class="mb-4 section-title">To Find an appropriate customer register here </h1>
                        <p>Our determination towards service of people will allow you to grow...</p>
                        <a href="" class="btn btn-primary mt-3 py-2 px-4">View More</a>
                    </div>
                    <div class="col-lg-6 p-0 pt-5 pt-lg-0">
                        <div class="owl-carousel service-carousel position-relative">
                            <div class="d-flex flex-column text-center bg-light mx-3 p-4">
                                <form action="RegisterCheckerA" method="post">

                                    <marquee width="75%" direction="left" height="100px"><h3 align="center"> For Accomodation Register here</h3></marquee>
                                    <table border="2px" align="center" > <tr>
                                            <td> Hostel name</td>
                                            <td><input type="text" required="required" name="hostelname" placeholder="Enter your hostel name"></td>
                                        </tr>

                                        <tr>
                                            <td> Name: </td>
                                            <td> <input type="text" name="name" required="required" placeholder ="Enter you name here.."/>
                                        </tr>
                                        <tr>
                                            <td> Contact: </td>
                                            <td><input type="text" maxlength="10" id="num" required="required" name="Contact" placeholder = "Enter your contact here.."/></td>
                                        </tr>
                                        <tr>
                                            <td> Hostel Address: </td>
                                            <td><input type="text" required="required" name="hosteladdress" placeholder="Enter your hostel address.."></td>
                                        </tr>
                                        <tr>
                                            <td> Email: </td> 
                                            <td><input type="email" required="required" name="Email" placeholder="Enter your E-mail here.."/></td>
                                        </tr>
                                        <tr>
                                            <td> Charges: </td>
                                            <td> <input type="number" required="required" id="name" name="charges" placeholder="Enter your charges.." ></td>
                                        </tr>
                                        <tr>
                                            <td> Furnished </td> 
                                            <td><input type="checkbox" name="Furnished"/></td>
                                        </tr>

                                        <tr>
                                            <td> Convence Facility </td>
                                            <td><input type="checkbox" name="convencefacility"></td>
                                        </tr>


                                        <tr>
                                            <td> Medical facility</td>
                                            <td><input type="checkbox"name="medicalfacility"></td>
                                        </tr>
                                        <tr>
                                            <td> Banking Facility</td>
                                            <td>  <input type="checkbox" name="bankingfacility"> </td>
                                        </tr>

                                        <tr>
                                            <td> Mess Facility</td>
                                            <td><input type="checkbox" name="messfacility" />  </td>
                                        </tr>

                                        <tr>
                                            <td> Pincode </td>
                                            <td><input type="text" required="required" name="Pincode" placeholder="Enter Pincode here.."/></td>
                                        </tr>
                                        <tr>
                                            <td> Password: </td>
                                            <td><input type="password" required="required" name="Password" placeholder="Enter your password here.."/></td>
                                        </tr>

                                        <tr>
                                            <td align="center"><button class="btn btn-lg btn-primary btn-block border-0" type="submit">Register</button></td>
                                                
                                            <td align="center"><button class="btn btn-lg btn-primary btn-block border-0" type="reset">Reset</button></td>
                                        </tr>
                                    </table>
                                </form><br/>
                                <p align="center"> Already registered? Click here to <a href="serviceLogin.jsp"><u> Login</u></p>
                            </div>
                        </div>
                    </div>
                </div>
